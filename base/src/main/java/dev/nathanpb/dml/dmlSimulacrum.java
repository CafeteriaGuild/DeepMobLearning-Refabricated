...
import dev.nathanpb.dml.block.SimulationChamber;
import dev.nathanpb.dml.block.entity.SimulationChamberEntity;
import dev.nathanpb.dml.config.Config;
import dev.nathanpb.dml.item.Items;
...
public class dmlSimulacrum {
    ...
    public static Identifier id(String path) {
        return new Identifier(DeepMobLearningKt.MOD_ID, path);
    }
    ...
    public static void initMaps() throws IllegalAccessException {
